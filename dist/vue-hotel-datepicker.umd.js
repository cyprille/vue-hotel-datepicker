...
// load the styles
var content = __webpack_require__("ca0e");
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("0a87b3c8", content, true, {"sourceMap":false,"shadowMode":false});
...
/* harmony default export */ var src_i18n = ({
  en: {
    ...
    minNights: {
      one: '%{count} night minimum',
      other: '%{count} nights minimum'
    },
  ...
  fr: {
    ...
    minNights: {
      one: '%{count} nuit minimum',
      other: '%{count} nuits minimum'
    },
    'check-in': 'Arrivée',
    'check-out': 'Départ',
...
/* harmony default export */ var helpers = ({
  ...
  compareDay: function compareDay(day1, day2) {
    ...
    var date1 = src_fecha.format(new Date(day1), 'YYYYMMDD');
    var date2 = src_fecha.format(new Date(day2), 'YYYYMMDD');
  ...
  pluralizedTranslation: function pluralizedTranslation(i18nKey, count) {
    var translation = i18nKey[count === 1 ? 'one' : 'other'];
    return translation === null || translation === void 0 ? void 0 : translation.replace('%{count}', count);
  },
  swipeAfterScroll: function swipeAfterScroll(direction) {
    if (this.screenSize !== 'desktop' && this.isOpen) {
      var swiperWrapper = document.getElementById('swiperWrapper'); // If wrapper has vertical scroll
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--13-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Day.vue?vue&type=script&lang=js&
...
/* harmony default export */ var Dayvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    dynamicTooltipMessage: function dynamicTooltipMessage() {
    ...
    tooltipMessage: function tooltipMessage() {
      return this.staticTooltipMessage || this.dynamicTooltipMessage;
    },
    showTooltip: function showTooltip() {
      return this.options.hoveringTooltip && this.isHovered && this.isEnabled && this.belongsToThisMonth && this.tooltipMessage;
    },
    ...
    isCheckInDay: function isCheckInDay() {
    ...
    isBeforeMinCheckOutDate: function isBeforeMinCheckOutDate() {
      if (!this.choosingCheckOut) return null;
      return this.compareDay(this.date, this.minCheckOutDate) == -1;
    },
    isAfterMaxCheckOutDate: function isAfterMaxCheckOutDate() {
      if (!this.maxCheckOutDate) return null;
      return this.compareDay(this.date, this.maxCheckOutDate) == 1;
    },
    isMissingPrice: function isMissingPrice() {
    ...
    dayClass: function dayClass() {
      ...
      var classes = [this.cssClass(this.isDisabled ? 'disabled' : 'valid')]; // Selection
      ...
      if (this.isCheckOutDay || this.isCurrentCheckOutCandidate) classes.push(this.cssClass('last-day-selected')); // Half-days
...
var component = normalizeComponent(
  ...
  Dayvue_type_template_id_8f6b7e34_lang_pug_render,
  Dayvue_type_template_id_8f6b7e34_lang_pug_staticRenderFns,
  false,
  null,
  null,
  null
...
var main = __webpack_require__("c1c3");
...
/* harmony default export */ var Appvue_type_script_lang_js_ = ({
  ...
  computed: {
    i18n: function (_i18n) {
      ...
      var i18nStore = this.customI18n || src_i18n;
    ...
    disabledDatesForCheckIn: function disabledDatesForCheckIn() {
    ...
    maxCheckOutDate: function maxCheckOutDate() {
      if (!this.choosingCheckOut) return null;
      var nextDisabledDate = this.getNextDate(this.disabledDatesForCheckOut, this.addDays(this.checkIn, 1));
      var maxDateValue = new Date(8640000000000000);
      return this.addDays(nextDisabledDate || maxDateValue, -1);
    },
    indexesOfMonthsToDisplay: function indexesOfMonthsToDisplay() {
      return Array.from(Array(this.numberOfMonthsToDisplay).keys());
    },
    paneStyleClass: function paneStyleClass() {
      if (this.numberOfMonthsToDisplay === 1) return 'datepicker__months-singlepane';
      return 'datepicker__months-dualpane';
    },
    datepickerClass: function datepickerClass() {
      return "datepicker--".concat(this.isOpen ? 'open' : 'closed');
    },
    ...
    alwaysOpen: function alwaysOpen() {
  ...
  watch: {
    isOpen: function isOpen(value) {
      ...
      if (!value && this.alwaysOpen) {
        // Prevent setting isOpen to false
        this.isOpen = true;
        return;
      }
      ...
      if (this.screenSize !== 'desktop') {
        ...
        if (value) {
          ...
          this.$nextTick(function () {
            ...
            var monthHeight = monthEl ? monthEl.offsetHeight : 1;
            swiperWrapper.scrollTop = _this2.activeMonthIndex * monthHeight;
          });
        } else {
  ...
  methods: _objectSpread2(_objectSpread2({}, helpers), {}, {
    formatDate: function formatDate(date) {
      if (date) {
        return src_fecha.format(date, this.format);
      }

      return '';
    },
    forceScreenSizeRecomputation: function forceScreenSizeRecomputation() {
    ...
    clickOutside: function clickOutside() {
      if (this.closeDatepickerOnClickOutside && this.screenSize === 'desktop') this.hideDatepicker();
    },
    ...
    renderNextMonth: lodash_throttle_default()(function throttleRenderNextMonth() {
      ...
      if (this.compareDay(firstDayOfLastMonth[0].date, this.endDate) == 0) return;
      this.createMonth(this.getNextMonth(firstDayOfLastMonth[0].date));
      this.activeMonthIndex++;
    }, 200),
    getDay: function getDay(date) {
      return src_fecha.format(date, 'D');
    },
    getMonth: function getMonth(date) {
      return this.i18n['month-names'][src_fecha.format(date, 'M') - 1] + (this.showYear ? src_fecha.format(date, ' YYYY') : '');
    },
